...
/**
 * Servlet implementation class TakeBoardSearchServlet
 */
@WebServlet(name = "TakeBoardSearch", urlPatterns = { "/takeBoardSearch" })
public class TakeBoardSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TakeBoardSearchServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(search.equals("boardName")) {
			//이름 검색
			sel=1;
			 bp = new SearchDogService().takeSearchBoard(reqPage,type,word,sel);
