...
/**
 * Servlet implementation class FindBoardInsertServlet
 */
@WebServlet(name = "FindBoardInsert", urlPatterns = { "/findBoardInsert" })
public class FindBoardInsertServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FindBoardInsertServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/finddog/FindBoardInsert.jsp");
