...
/**
 * Servlet implementation class TakeBoardUpdateSEServlet
 */
@WebServlet(name = "TakeBoardUpdateSE", urlPatterns = { "/takeBoardUpdateSE" })
public class TakeBoardUpdateSEServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TakeBoardUpdateSEServlet() {
        super();
