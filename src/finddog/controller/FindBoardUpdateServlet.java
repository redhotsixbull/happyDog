...
/**
 * Servlet implementation class FindBoardUpdateServlet
 */
@WebServlet(name = "FindBoardUpdate", urlPatterns = { "/findBoardUpdate" })
public class FindBoardUpdateServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FindBoardUpdateServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/finddog/FindBoardUpdate.jsp");
