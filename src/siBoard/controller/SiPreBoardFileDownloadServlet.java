 ...
 */
@WebServlet(name = "SiPreBoardFileDownload", urlPatterns = { "/siPreBoardFileDownload" })
public class SiPreBoardFileDownloadServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SiPreBoardFileDownloadServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String boardFilepath = request.getParameter("filepath");
		System.out.println(boardFilename+"/"+boardFilepath);
		//3.다운받을 파일의 경로 생성
		String saveDirectory = getServletContext().getRealPath("/siUpload/board/");
		//파일과 서블릿 연결
